...
#   --compressed | source <(curl -s 'https://gist.githubusercontent.com/Mobassar4u/6d28dba7588f2e17e376d8c75dea580e/raw/bash-json-parser') > source)
# }
...
{
    check_repo=$(curl -i -s -H "Authorization: token $git_token"     https://api.github.com/user/repos | grep 'Tata-Play-IPTV-Daily-Workflow-1') || true
...
ask_user_to_select()
{
    printf "\n Repo named 'Tata-Play-IPTV-Daily-Workflow-1' already exists, What would you like to perform? \n\n"
...
{
    if [[ $selection == '1' ]]; then
    dir=$(curl -s "https://$git_token@raw.githubusercontent.com/$git_id/Tata-Play-IPTV-Daily-Workflow-1/main/.github/workflows/Tata-Play-IPTV-Daily-Workflow-1.yml" | grep 'gist' | sed 's/.*\///g')
...
start()
{
    ...
    clear
    tput setaf 41; curl -s 'https://gist.githubusercontent.com/Mobassar4u/c4672f8e826a591fddbd0acf722e5160/raw/Image' || { tput setaf 9; echo " " && echo "This script needs active Internet Connection, Please Check and try again."; exit 1; }
    info;
    python='python3.9'
    take_vars;
...
create_gist()
{
    ...
    gh repo create Tata-Play-IPTV-Daily-Workflow-1 --private -y >> /dev/null 2>&1 || true
    fi
}
...
main()
{
    ...
    cat $LOCALDIR/dependencies/Tata-Play-IPTV-Daily-Workflow-1.yml | envsubst > Tata-Play-IPTV-Daily-Workflow-1.yml
    cd ../..
    ...
    git remote add origin "https://$git_token@github.com/$git_id/Tata-Play-IPTV-Daily-Workflow-1.git"
    dynamic_push;
    ...
    save_creds;
    tput setaf 51; echo "Successfully created your new private repo." && printf "Check your new private repo here: ${NC}https://github.com/$git_id/Tata-Play-IPTV-Daily-Workflow-1\n" && tput setaf 51; printf "Check Your Playlist URL here: ${NC}https://gist.githubusercontent.com/$git_id/$dir/raw/TataPlayPlaylist.m3u \n"
    if [[ "$selection" == '2' ]]; then tput setaf 51; echo -e "Check your other playlist branch here: ${NC}https://github.com/$git_id/Tata-Play-IPTV-Daily-Workflow-1/tree/$dir"; fi
    ...
    tput setaf 51; echo "Credits: Mobassar@4u (https://github.com/Mobassar4u/Tata-Play-IPTV-India) & Only Me"
